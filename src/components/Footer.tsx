...
const Footer = () => {
  return (
    <div className=" ">
      <div className=" bg-green-50 text-green-500 pt-9">
        <div className="mx-auto w-full max-w-[1166px] px-4 xl:px-0">
          <div className="flex flex-col justify-between sm:px-[18px] md:flex-row md:px-10">
            <div className="md:w-[316px]">
              <div className="text-[18px] font-medium">
                <Image src="/logo.png" alt="" width={30} height={30} />
                <h1 className=" font-extrabold text-green-500">Iya Basira</h1>
              </div>
            ...
            <div className="md:w-[316px]">
              ...
              <div className="mt-[23px] flex">
                ...
                <div className="ml-[18px]">
                  <a
                    href="mailto:iyabasira@email.com"
                    className="font-Inter text-[14px] font-medium text-green-500"
                  >
                    iyabasira@email.com
                  </a>
                  <p className="font-Inter text-[12px] font-medium text-green-500">
                    Support Email
                  </p>
                </div>
              </div>
          ...
          <div className="flex items-center justify-center pb-8 pt-[9px] md:py-8">
            <p className="text-[10px] font-normal  md:text-[12px]">
              © Copyright 2024 , All Rights Reserved by IYA BASIRA
            </p>
          </div>
        </div>
      </div>
